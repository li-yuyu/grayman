...
/**
 * 代理类加载器，用来加载相对路径plugin包下的lib：
 *   agent.jar 由 AppClassLoader 加载
 *   agent-plugin 和 agent-util 由 AgentClassLoader 加载
 */
public class AgentClassLoader extends ClassLoader {
    ...
    public AgentClassLoader(ClassLoader parent) {
        ...
        classpath.add(new File(AgentPackagePath.getPath(), "plugin"));
