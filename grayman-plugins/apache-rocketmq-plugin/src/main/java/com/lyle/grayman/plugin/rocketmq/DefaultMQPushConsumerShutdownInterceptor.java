...
public class DefaultMQPushConsumerShutdownInterceptor implements InstanceMethodInterceptor {
    @Override
    public Object intercept(Object obj, Object[] allArguments, Callable<?> zuper, Method method) throws Throwable {
        ...
        if (pushConsumer != null) {
            ...
            PushConsumerHolder.removePushConsumer(consumer.hashCode());
            AgentLogger.getLogger().info("消费者停止" + pushConsumer.getConsumerGroup());
        }
