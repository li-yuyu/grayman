...
public class DefaultMQPushConsumerSuspendInterceptor implements InstanceMethodInterceptor {
    @Override
    public Object intercept(Object obj, Object[] allArguments, Callable<?> zuper, Method method) throws Throwable {
        ...
        if (pushConsumer != null) {
            ...
            AgentLogger.getLogger().info("暂停消费" + pushConsumer.getConsumerGroup());
        }
